...
chat_model_name = "microsoft/phi-2"
...
def encode_chat_question(question: str, context: str):
    return f"Write an answer to the question \"{question}\" including the words \"{context}\"."
...
chat_results = chat_model(chat_prompt, max_length=chat_max_length, num_return_sequences=chat_num_return_sequences, truncation=False)
